  ...
  return (
    <div className="w-full flex flex-col gap-6">
      ...
      >
        ...
        <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-6 text-ellipsis overflow-hidden whitespace-nowrap" onClick={openMail} title="Leer mail">
          <span className="border-slate-400 text-ellipsis whitespace-nowrap">{email}</span>
          <span title={translateSection(section)} className="block md:hidden lg:block">
